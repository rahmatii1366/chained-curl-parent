...
@Component({
  selector: 'app-chained-curl-list',
  standalone: true,
  providers: [
  ...
  templateUrl: './chained-curl-list.component.html',
  styleUrl: './chained-curl-list.component.css'
})
export class ChainedCurlListComponent implements OnInit {
  ...
  set chainedCurlDto(_chainedCurlDto: ChainedCurlServerConfig | any) {
    ...
    console.log("active")
    this._activeChainedCurl$.next(this._chainedCurlDto.chainedCurlDto.name)
